...
export const getHoldingsSucccess = myHoldings => ({
    ...
    return axios({
      ...
      .then(response => {
        if (response.status === 200) {
          let myHoldigns = response.data.map(item => {
          ...
          dispatch(getHoldingsSucccess(myHoldigns));
        } else {
...
export const getCoinMarketSucccess = coins => ({
